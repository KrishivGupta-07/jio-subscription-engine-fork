...
public class ProductRefOrValue {
  ...
  private @Nullable String randomAtt;
  ...
  public ProductRefOrValue randomAtt(@Nullable String randomAtt) {
  ...
  @Schema(name = "randomAtt", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("randomAtt")
  public @Nullable String getRandomAtt() {
    return randomAtt;
  }

  @JsonProperty("randomAtt")
  public void setRandomAtt(@Nullable String randomAtt) {
    this.randomAtt = randomAtt;
  }
  ...
  public ProductRefOrValue atSchemaLocation(@Nullable String atSchemaLocation) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, productRefOrValue.id) &&
        ...
        Objects.equals(this.randomAtt, productRefOrValue.randomAtt) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, href, description, isBundle, isCustomerVisible, name, orderDate, productSerialNumber, randomAtt, startDate, terminationDate, agreement, billingAccount, place, product, productCharacteristic, productOffering, productOrderItem, productPrice, productRelationship, productSpecification, productTerm, realizingResource, realizingService, relatedParty, status, atBaseType, atSchemaLocation, atType, atReferredType);
  }
  ...
  public String toString() {
    ...
    sb.append("    randomAtt: ").append(toIndentedString(randomAtt)).append("\n");
